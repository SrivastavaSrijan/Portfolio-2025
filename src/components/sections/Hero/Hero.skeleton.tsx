...
export function HeroSkeleton() {
  return (
    <div className="mx-auto flex h-full min-h-[calc(100vh-52px)] w-full max-w-[1440px] flex-grow flex-col gap-7 px-5 py-5 lg:min-h-[calc(100vh-94px)] lg:gap-8 lg:px-20 lg:py-10">
      {/* Name skeleton */}
