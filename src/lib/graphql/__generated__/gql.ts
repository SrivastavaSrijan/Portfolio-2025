...
const documents: Documents = {
    ...
    "query GetCaseStudiesByOptionalTags($tagIds: [JSON]) {\n  CaseStudies(where: {tags: {in: $tagIds}}) {\n    offset\n    totalDocs\n    docs {\n      id\n      slug\n      title\n      tags {\n        name\n        id\n      }\n      updatedAt\n      illustration {\n        url\n        alt\n      }\n      experience {\n        role\n        title\n        slug\n      }\n    }\n    pagingCounter\n  }\n  Journal {\n    title\n    subtitle\n    description\n  }\n}": types.GetCaseStudiesByOptionalTagsDocument,
 ...
 * The gql function is used to parse GraphQL queries into a document that can be used by GraphQL clients.
 */
export function gql(source: "query GetCaseStudiesByOptionalTags($tagIds: [JSON]) {\n  CaseStudies(where: {tags: {in: $tagIds}}) {\n    offset\n    totalDocs\n    docs {\n      id\n      slug\n      title\n      tags {\n        name\n        id\n      }\n      updatedAt\n      illustration {\n        url\n        alt\n      }\n      experience {\n        role\n        title\n        slug\n      }\n    }\n    pagingCounter\n  }\n  Journal {\n    title\n    subtitle\n    description\n  }\n}"): (typeof documents)["query GetCaseStudiesByOptionalTags($tagIds: [JSON]) {\n  CaseStudies(where: {tags: {in: $tagIds}}) {\n    offset\n    totalDocs\n    docs {\n      id\n      slug\n      title\n      tags {\n        name\n        id\n      }\n      updatedAt\n      illustration {\n        url\n        alt\n      }\n      experience {\n        role\n        title\n        slug\n      }\n    }\n    pagingCounter\n  }\n  Journal {\n    title\n    subtitle\n    description\n  }\n}"];
/**
 * The gql function is used to parse GraphQL queries into a document that can be used by GraphQL clients.
 */
